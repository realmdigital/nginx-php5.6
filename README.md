 ...
 * git, composer
 * php 5.6 (fpm, cli, mysql, apc, curl, gd, intl, mcrypt, mbstring, memcache, memcached, sqlite, tidy, xmlrpc, xsl, pgsql, mongo, ldap, soap, xdebug)
...
```yaml
  web:
    image: realmdigital/nginx-php5.6
    container_name: web
    restart: always
    volumes:
